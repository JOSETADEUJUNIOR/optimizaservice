        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Cadastro de usuarios Admin</h4>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-sm-12 col-12">
                            <div class="form-group">
                                <label>Plano</label>
                                <select id="plano" class="select" aria-hidden="true">
                        ...
                        <div class="col-lg-12">
                            <button onclick="return CadastrarUsuarioAdmin()" class="btn btn-submit me-2">Cadastrar</button>
                            <a href="empresas.php" class="btn btn-cancel">Cancelar</a>
                        </div>
                    </div>
                </div>
            </div>

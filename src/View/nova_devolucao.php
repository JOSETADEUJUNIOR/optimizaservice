        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Criar estorno de venda</h4>
                    <h6>Adicione os estornos das vendas realizadas</h6>
                </div>
            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2 col-sm-2 col-2 ps-0">
                                            <div class="add-icon">
                                                <a href="javascript:void(0);"><img src="../Template/assets/img/icons/plus1.svg"
                                                        alt="img"></a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>250</td>
                                            <td>
                                                <a class="delete-set"><img src="../Template/assets/img/icons/delete.svg"
                                                        alt="svg"></a>
                                            </td>
                                        </tr>
                                        <tr>

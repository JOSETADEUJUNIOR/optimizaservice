...
<body cz-shortcut-listen="true">
        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Listagem de tipos de serviços</h4>
                    <h6>Gerencie seus tipos de serviços para OS</h6>
                </div>
                <div class="page-btn">
                    <a href="novo_servico.php" class="btn btn-added"><img src="../Template/assets/img/icons/plus.svg" alt="img" class="me-1">Novo tipo serviço</a>
                </div>
            </div>
                                ...
                                <div class="col-lg-12 col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1 col-sm-6 col-12">
                                            <div class="form-group">
                                                <a onclick="FiltrarTpServico()"class="btn btn-filters ms-auto"><img src="../Template/assets/img/icons/search-whites.svg" alt="img"></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="../Resource/ajax/tp_servico-ajx.js"></script>

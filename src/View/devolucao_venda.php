        ...
        <div class="content">
            <div class="page-header">
                <div class="page-title">
                    <h4>Listagem das devoluções</h4>
                    <h6>Gerencie suas devoluções de vendas</h6>
                </div>
                <div class="page-btn">
                    <a href="nova_devolucao.php" class="btn btn-added"><img src="../Template/assets/img/icons/plus.svg" alt="img" class="me-1">Nova devolução</a>
                </div>
            </div>

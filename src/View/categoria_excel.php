...
$sheet->setCellValue('A1', 'Nome Categoria');
...
foreach ($dados as $registro) {
    $sheet->setCellValue('A' . $row, $registro['nome_categoria']);
    $sheet->setCellValue('B' . $row, $registro['cod']);
    $sheet->setCellValue('C' . $row, $registro['descricao_categoria']);
    $sheet->setCellValue('D' . $row, $registro['status']);

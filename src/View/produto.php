        ...
        <div class="content">
            ...
            <div class="card">
                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg col-sm-6 col-12">
                                            <div class="form-group">
                                                <input id="filtrar_produto" type="text" placeholder="Filtrar por nome">
                                            </div>
                                        </div>
                                        <div class="col-lg col-sm-6 col-12">
                                            <div class="form-group">
                                                <select class="select categoria" id="categoria_id_alt">
                    ...
                    <div id="table_produto" class="table-responsive">

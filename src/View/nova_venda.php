                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <div class="input-groupicon">
                                    <select class="select" id="produto_venda">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-sm-6 col-12">
                            <div class="form-group">
                                ...
                                <input id="valor_entrega" type="text">
                            </div>
                        </div>
                        <div class="col-lg-6 col-sm-6 col-12">
                            <div class="form-group">
                            ...
                            <div class="col-lg-12 ">
                                <div class="total-order w-100 max-widthauto m-auto mb-4">
                                    <ul>
                                        <li>
                                            <h4>Desconto </h4>
                                            <h5 id="total_desconto">$ 0.00</h5>
                                        </li>
                                        <li>
                                            <h4>Entrega</h4>
                                            <h5 id="total_entrega">$ 0.00</h5>
                                        </li>
                                        <li class="total">
                                            <h4>Valor Total</h4>
                                            <h5 id="total_geral">$ 0.00</h5>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <a href="javascript:void(0);" id="btnGravar" class="btn btn-submit me-2">Gravar</a>
